...
<tbody>
  <tr>
    <td>Atta</td>
    <td bgcolor="#b6d7a8">Yes</td>
    <td bgcolor="#b6d7a8">Yes</td>
    <td bgcolor="#b6d7a8">Yes</td>
  </tr>
  <tr>
    <td>Maida</td>
    <td bgcolor="#f4cccc">No</td>
    <td bgcolor="#f4cccc">No</td>
    <td bgcolor="#b6d7a8">Yes</td>
  </tr>
  <tr>
    <td>Carbs/g</td>
    <td bgcolor="#b6d7a8">63</td>
    <td bgcolor="#b6d7a8">52</td>
    <td bgcolor="#b6d7a8">79</td>
  </tr>
  <tr>
    <td>Proteins/g</td>
    <td bgcolor="#e7cec5">16</td>
    <td bgcolor="#e7cec5">23</td>
    <td bgcolor="#f4cccc">7</td>
  </tr>
  <tr>
    <td>Fats/g</td>
    <td bgcolor="#f4cccc">3</td>
    <td bgcolor="#f4cccc">10</td>
    <td bgcolor="#f4cccc">0</td>
  </tr>
  <tr>
    <td>Fiber/g</td>
    <td bgcolor="#d3d1b9">43</td>
    <td bgcolor="#f4cccc">14</td>
    <td bgcolor="#f4cccc">4</td>
  </tr>
  <tr>
    <td>Iron<br>(% of daily req.)</td>
    <td bgcolor="#b6d7a8">59</td>
    <td bgcolor="#d3d1b9">35</td>
    <td bgcolor="#f4cccc">7</td>
  </tr>
  <tr>
    <td>Others</td>
    <td>Vitamin Bs</td>
    <td>Vitamin Bs<br>omega-3/6 lipids</td>
    <td></td>
  </tr>
</tbody>
</table>
